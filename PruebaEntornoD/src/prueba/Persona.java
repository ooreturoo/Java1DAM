...
public class Persona {
	 ...
	 * @param dni Recibe un n�mero que tiene que ser de 8 d�gitos.
	...
	public Persona(String nombre, LocalDate fechaNacimiento,int dni, char sexo) {
		...
		if(comprobarDni(dni) == 8) {//Comprueba si dni tiene 8 d�gitos, si es asi le da valor al atributo dni
			this.dni = dni;			
		}
	...
	/**
	 * Obtiene el IMC a trav�s de la alturay el peso.
	 * @return
	 */
	public float getIMC() {
		/*
	 ...
	 * @return Devuelve el n�mero de cifras.
	 */
