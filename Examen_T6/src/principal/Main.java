...
import elementos.Cromo;
import elementos.Escudo;
...
public class Main {
		...
		while (!fin) {
			try {
				...
				case 2:
					...
					m1.intercambioCromo(cromoParaCambiar, cromoDelOtro);
				...
				case 3:
					...
					break;
				case 4:
					System.out.println("Actualmente tienes " + m1.contarCromosDiferentes() + " cromos diferentes");
					break;
				case 5:
					System.out.println("�De qu� equipo quieres mostrar los cromos?: ");
					String equipoMostrar = sc.nextLine();
					m1.devolverCromosMismoEquipo(equipoMostrar).stream().forEach(System.out::println);
					break;
				case 6:
					System.out.println("�De qu� equipo quieres mostrar la altura media?: ");
					String equipoAltura = sc.nextLine();
					System.out.println(m1.calcularAlturaEquipo(equipoAltura));
					break;
				case 7:
					m1.devolverListaCromosTotales().stream().forEach(System.out::println);
					break;
				case 8:
					m1.devolverListaCromosOrdenados().stream().forEach(System.out::println);
					break;
				case 9:
					m1.equiposCompletos().stream().forEach(System.out::println);
					break;
				case 10:
	...
	private static void mostrarCromosDeMazo(Mazo m) {
		m.devolverListaCromosTotales().forEach(System.out::println);
	}
